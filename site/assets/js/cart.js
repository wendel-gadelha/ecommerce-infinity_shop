document.addEventListener('DOMContentLoaded', function() {
    const cartLink = document.querySelector('.nav-list #cart-link');
    ...
    if (cartLink) {
        ...
        console.error('Elemento #cart-link não encontrado no DOM.');
    }
    ...
    const lisProductHTML = document.querySelector('.list-product');
